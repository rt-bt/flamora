        ...
        {navItems.map((item, idx) => {
          ...
          const iconEl = (
            <div className="flex flex-col items-center">
              <span className={cn("mb-1.5", isActive ? "text-[#00796B]" : "text-[#292929]")}>
                {item.icon}
              </span>
              <p className={cn("text-xs leading-[14.4px] font-normal", isActive ? "text-[#00796B] font-semibold" : "text-[#6B7280]")}>
                {item.label}
              </p>
            </div>
          );
